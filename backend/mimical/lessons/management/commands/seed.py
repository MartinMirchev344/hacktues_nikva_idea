...
ALPHABET_SIGNS = [
    (
        "A",
        "Make a fist with your thumb resting along the side of your hand.",
    ),
    (
        "B",
        "Hold your hand upright with four fingers straight up and your thumb folded across your palm.",
    ),
    (
        "C",
        "Curve your fingers and thumb into the shape of the letter C.",
    ),
    (
        "D",
        "Touch your thumb to your middle finger and ring finger while your index finger points straight up.",
    ),
    (
        "E",
        "Curl all four fingers down toward your thumb, keeping the fingertips close to the thumb.",
    ),
    (
        "F",
        "Touch your index finger to your thumb to make a circle and hold the other three fingers up.",
    ),
    (
        "G",
        "Point your index finger and thumb sideways, parallel to the ground, with the other fingers closed.",
    ),
    (
        "H",
        "Extend your index and middle fingers together sideways with the other fingers folded down.",
    ),
    (
        "I",
        "Make a fist and extend only your pinky finger upward.",
    ),
    (
        "J",
        "Start with the pinky handshape and draw the letter J in the air with your pinky.",
    ),
    (
        "K",
        "Raise your index and middle fingers in a V shape and place your thumb against the middle finger.",
    ),
    (
        "L",
        "Extend your thumb and index finger to make an L shape while the other fingers stay folded.",
    ),
    (
        "M",
        "Tuck your thumb under your index, middle, and ring fingers, leaving three fingers resting over it.",
    ),
    (
        "N",
        "Tuck your thumb under your index and middle fingers, leaving two fingers resting over it.",
    ),
    (
        "O",
    ...
    (
        "P",
        "Form the K handshape and angle it downward so the fingers point toward the floor.",
    ),
    (
        "Q",
        "Form the G handshape and angle it downward so the fingers point toward the floor.",
    ),
    (
        "R",
        "Cross your middle finger over your index finger with the other fingers folded.",
    ),
    (
        "S",
        "Make a fist with your thumb wrapped across the front of your fingers.",
    ),
    (
        "T",
        "Make a fist and tuck your thumb between your index finger and middle finger.",
    ),
    (
        "U",
        "Hold your index and middle fingers straight up together with the other fingers folded.",
    ),
    (
        "V",
        "Hold your index and middle fingers up in a V shape with the other fingers folded.",
    ),
    (
        "W",
        "Hold your index, middle, and ring fingers up spread apart with your thumb and pinky tucked in.",
    ),
    (
        "X",
        "Make a fist and bend your index finger into a hook shape.",
    ),
    (
        "Y",
        "Extend your thumb and pinky outward with the other fingers folded.",
    ),
    (
        "Z",
...
ALPHABET_PRACTICE_LETTERS = ["B", "D", "V", "A", "W"]
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        legacy_alphabet_lessons = Lesson.objects.filter(title__startswith="Lesson 0: ")
        deleted_legacy_lessons = legacy_alphabet_lessons.count()
        if deleted_legacy_lessons:
            legacy_alphabet_lessons.delete()

        for lesson_data in SEED_DATA:
            exercises_data = lesson_data["exercises"]
            lesson_fields = {
                **{k: v for k, v in lesson_data.items() if k not in {"exercises", "id"}},
                "sign_language": "ASL",
                "is_published": True,
            }
            ...
            if lesson_id is not None:
                existing_by_title = Lesson.objects.filter(title=lesson_data["title"]).exclude(pk=lesson_id).first()
                if existing_by_title:
                    Exercise.objects.filter(lesson=existing_by_title).delete()
                    existing_by_title.delete()
        ...
        self.stdout.write(self.style.SUCCESS(
            ...
            f"deleted {deleted_legacy_lessons} legacy alphabet lessons."
        ))
